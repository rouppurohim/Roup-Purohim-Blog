      ...
      <div className="max-w-[1400px] mx-auto px-6 flex flex-col md:flex-row justify-between items-start gap-12">
        ...
        <div className="flex flex-col items-end gap-6">
          <div className="flex gap-8">
            ...
            <a href={AUTHOR.social.instagram} target="_blank" rel="noopener noreferrer" className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-accent transition-colors">Instagram</a>
